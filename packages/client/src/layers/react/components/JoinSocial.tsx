...
export const JoinSocial: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  return (
    <SocialContainer onClose={onClose}>
      ...
      <Buttons>
        <Button onClick={() => window.open("https://discord.com/invite/WMXwkcGnNk", "blank")}>Discord</Button>
        <Button onClick={() => window.open("https://twitter.com/Deplug_Studio", "blank")}>Twitter</Button>
      </Buttons>
    </SocialContainer>
  );
};
